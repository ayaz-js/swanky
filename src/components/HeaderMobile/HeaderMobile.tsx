...
export const HeaderMobile: FC<Props> = ({ onArrowClick, headerSection }) => {
  return (
    <header className="header-mobile" ref={headerSection}>
      <div className="header-mobile__wrapper">
        ...
        <div className="header-mobile__contact-block">
          ...
          <div className="header-mobile__contact">
            <a href="tel:+77764447723" className="header-mobile__link header-mobile__link_phone">+77764447723 (WhatsApp)</a>
            <p className="header-mobile__text">оптовые продажи для ресторанов и баров</p>
          </div>
        </div>
